...
import com.coding.challenge.selenium.framework.service.DateTimeConverter;
import com.coding.challenge.selenium.page.weatherapp.WeatherAppHomePage;
...
public class WeatherUISteps {
    ...
    public void navigateToHomePage(String homePageUrl) {
        weatherAppHomePage.maximizeWindow();
